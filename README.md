...
- **🔡 Google Fonts**: Professional typography using _Manrope_ and _Source Serif 4_.
...
- `ARCHITECTURE.md` — 🏗️ Visual data-flow and system design guide.
...
> **Documentation Updates**: View the technical [ARCHITECTURE.md](./ARCHITECTURE.md), the working principles in [INSTRUCTIONS.md](./INSTRUCTIONS.md), and our [LICENSE](./LICENSE).
